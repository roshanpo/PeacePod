...
const InstrumentalMusic = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://127.0.0.1:8000/api/category/Instrumental/") 
  ...
  return (
    ...
    {/* <div className="w-full h-full lg:ml-56"> */}
      <div className="grid xss:grid-cols-2 md:grid-cols-2 md:grid-rows-5 lg:grid-cols-3 gap-4 lg:grid-rows-3 pb-4">
