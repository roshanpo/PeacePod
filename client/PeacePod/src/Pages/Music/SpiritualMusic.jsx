...
const SpiritualMusic = () => {
  const [allMusic, setAllMusic] = useState([])

  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://127.0.0.1:8000/api/category/spiritual") // Replace with your API endpoint
