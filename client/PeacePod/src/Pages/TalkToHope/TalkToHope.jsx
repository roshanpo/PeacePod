...
export const TalkToHope = () => {
  ...
  const [messages, setMessages] = useState([
    {
      message: "Hello i am HOPE bot.",
      sender: "HOPE",
    },
    {
      message: "Try asking: How to get started with meditation?",
      sender: "HOPE"
    }
  ])
  ...
  return (
    <>
      <div className="w-full h-screen lg:ml-52 bot-background"> </div>
        <div className="absolute z-10 flex justify-center items-center mt-7 left-[600px]">
          <button
